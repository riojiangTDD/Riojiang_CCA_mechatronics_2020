...
int IN1 = 11;  // MCU Digital Pin 9 to IN1 on L298n Board 
int IN2 = 9;  // MCU Digital Pin 8 to IN2 on L298n Board

int ENB = 5;  // MCU PWM Pin 5 to ENB on L298n Board
int IN3 = 8;  // MCU Digital pin 7 to IN3 on L298n Board
int IN4 = 7;  // MCU Digital pin 6 to IN4 on L298n Board
